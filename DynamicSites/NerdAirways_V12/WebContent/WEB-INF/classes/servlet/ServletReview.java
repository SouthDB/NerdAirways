...
public class ServletReview extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		List<String> slist = (new DAOReview(this.getServletContext())).listAll();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Collection<AwBooking> bc = (new DAOBooking(this.getServletContext())).listByBookingnr(bookingnr);
		if(bc.size() == 0){
			...
			(new DAOReview(this.getServletContext())).saveReview(bookingid,rating, text);
