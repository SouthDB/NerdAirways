        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(login == "false"){
                    ...
                    "<li class=\"navlink2\"><input class=\"rightinput inputs\" type=\"password\" name=\"pw\" placeholder=\"Passwort...\" required> </li>" +
                    "<li class=\"navlink2\"><input class=\"rightinput inputs\" type=\"text\" name=\"username\" placeholder=\"Benutzername...\" required> </li>" +
