...
public class ServletAccountUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AwCustomer c = (new DAOCustomer(this.getServletContext()).findCustomer(luser));
		...
		(new DAOCustomer(this.getServletContext())).updateCustomer(c, adress, birthdate, counid, email, fname, gender, place, plz, pw, sname, username);
		...
		(new DAOCreditcard(this.getServletContext())).updateCreditcard(cred, cardnr, cardtype, holder);
