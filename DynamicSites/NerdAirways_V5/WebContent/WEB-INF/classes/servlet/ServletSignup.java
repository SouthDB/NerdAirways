...
public class ServletSignup extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		(new DAOCreditcard()).saveCreditcard(cardnr, cardtype, holder,  this.getServletContext());
		(new DAOCustomer()).saveCustomer(adress, birthdate, counid, email, fname, gender, place, plz, pw, sname, username, this.getServletContext());
