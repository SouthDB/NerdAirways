...
public class DAOBooking {
	...
	public AwBooking findBooking(BigDecimal id, ServletContext sc) {
		EntityManager em = (EntityManager) sc.getAttribute("em");
		return em.find(AwBooking.class, id.longValue());
	}
	
	
	public Collection<AwBooking> listByBookingnr(BigDecimal bookingnr, ServletContext sc){
		EntityManager em = (EntityManager)sc.getAttribute("em");
