...
public class AwCustomer implements Serializable {
	...
	public AwCustomer(String adress, Date birthdate, BigDecimal counid, BigDecimal credid, String email, String fname, String gender, String place, String plz, String pw, String sname, String username){
		this.adress = adress;
