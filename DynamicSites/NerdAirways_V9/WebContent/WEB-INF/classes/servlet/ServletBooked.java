...
public class ServletBooked extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Collection<AwBooking> bookedcollect = (new DAOBooking()).listByCustId((new BigDecimal("1")), this.getServletContext());
		for (AwBooking o : bookedcollect) {
			...
			String checkinUrl = "http://localhost:8080/NerdAirways/booked/?bookid=" + o.getId() + "\"";
