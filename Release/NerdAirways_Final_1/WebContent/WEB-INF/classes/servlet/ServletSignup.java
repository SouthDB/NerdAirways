...
public class ServletSignup extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		(new DAOCreditcard(emf)).saveCreditcard(cardnr, cardtype, holder);
		(new DAOCustomer(emf)).saveCustomer(adress, birthdate, counid, email, fname, gender, place, plz, pw, sname, username);
